...
public class TestyOmdlenie extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_testy_omdlenie);
        ...
        cofnijBigBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TestyOmdlenie.this, TestyLista.class);
        ...
        option1Btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (queList.get(aktualnePytanie).getAnswer().trim().toLowerCase()
    ...
    private void pokazDolneMenu() {
        ...
        BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(TestyOmdlenie.this);
        ...
        TextView wynikTestu = bottomSheetView.findViewById(R.id.idWynikTestu);
        Button restartQuizBtn = bottomSheetView.findViewById(R.id.idBtnRestart);
        Button cofnijBtn = bottomSheetView.findViewById(R.id.idCofnijBtn);
        wynikTestu.setText("Your score is: \n" + wynik + "/" + queList.size());
    ...
    private void pytaniaQuizu(ArrayList<Pytanie> quizModalArrayList) {
        ...
        quizModalArrayList.add(new Pytanie("Omdlenie jest efektem: ",
                "patologicznych wyładowań w tkance mózgowej.",
                "wzrostu ciśnienia w ośrodkowym układzie nerwowym.",
                "upośledzenia perfuzji przez naczynia mózgowe.",
                "żadne z wymienionych.",
                "upośledzenia perfuzji przez naczynia mózgowe." ));

        quizModalArrayList.add(new Pytanie("Cechą omdlenia jest: ",
                "nagłe wystąpienia.",
                "całkowita utrata przytomności.",
                "szybkie i całkowite ustąpienie objawów.",
                "wszystkie wymienione.",
                "wszystkie wymienione." ));

        quizModalArrayList.add(new Pytanie("Do omdlenia wazowagalnego może dojść w wyniku: ",
                "instrumentacji na dużych naczyniach i na widok krwi.",
                "podczas wysiłku.",
                "na widok krwi.",
                "instrumentacji na dużych naczyniach.",
                "instrumentacji na dużych naczyniach i na widok krwi." ));

        quizModalArrayList.add(new Pytanie("W omdleniu odruchowym stwierdza się: ",
                "zwolnienie akcji serca i poszerzenie łożyska naczyniowego.",
                "tylko zwolnienie akcji serca.",
                "zwolnienie akcji serca i skurcz naczyń.",
                "przyśpieszenie akcji serca i skurcz naczyń.",
                "zwolnienie akcji serca i poszerzenie łożyska naczyniowego." ));

        quizModalArrayList.add(new Pytanie("Objawem poprzedzającym omdlenie z powodu niedociśnienia ortostatycznego może być: ",
                "parcie na mocz.",
                "szum w uszach.",
        ...
        quizModalArrayList.add(new Pytanie("Najpoważniejsze rokowanie mają omdlenia: ",
                "wazowagalne.",
                "kardiogenne.",
                "z niedociśnienia ortostatycznego.",
                "odruchowe.",
                "kardiogenne." ));
